...
if (faq) {
  ...
  const faqURL = '/bakery/fakedata/faq.json';
  let faqTemplate = '';
  let ans = '';
  fetch(faqURL)
    .then((response) => {
...
if (produt) {
  ...
  async function fetchData() {
    try {
      const response = await fetch('/bakery/fakedata/bread.json');
...
if (news) {
  ...
  const url = '/bakery/fakedata/news.json';
...
if (homePage) {
  //productCarousel
  fetch('/bakery/fakedata/bread.json')
    .then(res => res.json())
    .then(productData => {
  ...
  fetch('/bakery/fakedata/news.json')
    .then(res => res.json())
    .then(newsData => {
  ...
  fetch('/bakery/fakedata/branches.json')
    .then(res => res.json())
    .then(branches => {
